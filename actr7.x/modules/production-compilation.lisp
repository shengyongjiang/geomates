...
;;; Version     : 6.1
;;; 
;;; Description : Implements the production compilation mechanism in ACT-R 6.
;;; 
;;; Bugs        : 
;;;
...
;;; 2023.06.30 Dan [6.1]
;;;             : * Sort the buffers by index when creating the new production
;;;             :   so that the created productions always look the same.
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;
;;; General Docs:
;;; 
  ...
  (let* ((p1-basic-vars (basic-variables module p1))
    ...
    (let* ((mappings nil)
      ...
      (let ((p3-s (list nil nil)))
        (dolist (buffer (sort (copy-list used-buffers) #'< :key 'buffer-index))
