...
;;; 2022.11.29 Dan
;;;             : * Added the whynot error results for the new :*-value 
;;;             :   request parameters.
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;
;;; General Docs:
              ...
              ((last-request-invalid last)
               (command-output "Last retrieval request was at time ~/print-time-in-seconds/ but was invalid because: ~a" (last-request-time last)
                               (case (last-request-invalid last)
                                 ...
                                 (:rt-multi ":rt-value specified more than once.")
                                 (:rt-modifier ":rt-value had a modifier other than =.")
                                 (:rt-not-num ":rt-value was not a number.")
                                 (:bll-multi ":bll-value specified more than once.")
                                 (:bll-modifier ":bll-value had a modifier other than =.")
                                 (:bll-not-num ":bll-value was not a positive number or nil.")
                                 (:ans-multi ":ans-value specified more than once.")
                                 (:ans-modifier ":ans-value had a modifier other than =.")
                                 (:ans-not-num ":ans-value was not a positive number or nil.")
                                 (:mas-multi ":mas-value specified more than once.")
                                 (:mas-modifier ":mas-value had a modifier other than =.")
                                 (:mas-not-num ":mas-value was not a number or nil.")))
