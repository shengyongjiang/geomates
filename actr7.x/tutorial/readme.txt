...
ODT (OpenDocument Text) or PDF files (depending on where you
...
describe the ACT-R commands introduced in the main unit text
...
provided model which does not work correctly.
