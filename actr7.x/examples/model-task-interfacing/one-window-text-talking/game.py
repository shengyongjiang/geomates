...
>>> game.play('model1','model2')
     ...
     2.050  MODEL1  SPEECH                 PREPARATION-COMPLETE 2.05
     2.050  MODEL1  PROCEDURAL             CONFLICT-RESOLUTION
     2.100  MODEL1  SPEECH                 INITIATION-COMPLETE 2.05
     2.100  MODEL1  AUDIO                  new-sound
     2.100  MODEL1  MICROPHONE             output-speech MODEL1 two
     2.100  MODEL2  AUDIO                  new-sound
     2.100  MODEL2  VISION                 proc-display
     2.100  MODEL2  VISION                 SET-BUFFER-CHUNK VISUAL-LOCATION VISUAL-LOCATION6 NIL
     2.100  MODEL2  VISION                 visicon-update
     2.100  MODEL1  VISION                 proc-display
     2.100  MODEL1  VISION                 SET-BUFFER-CHUNK VISUAL-LOCATION VISUAL-LOCATION6 NIL
     2.100  MODEL1  VISION                 visicon-update
     2.100  MODEL1  PROCEDURAL             CONFLICT-RESOLUTION
     2.100  MODEL1  PROCEDURAL             PRODUCTION-SELECTED GAME-OVER
     2.100  MODEL1  PROCEDURAL             BUFFER-READ-ACTION VISUAL-LOCATION
     2.100  MODEL1  PROCEDURAL             QUERY-BUFFER-ACTION VISUAL
     2.100  MODEL2  PROCEDURAL             CONFLICT-RESOLUTION
     2.100  MODEL2  PROCEDURAL             PRODUCTION-SELECTED GAME-OVER
     2.100  MODEL2  PROCEDURAL             BUFFER-READ-ACTION VISUAL-LOCATION
     2.100  MODEL2  PROCEDURAL             QUERY-BUFFER-ACTION VISUAL
     2.150  MODEL1  PROCEDURAL             PRODUCTION-FIRED GAME-OVER
     2.150  MODEL1  PROCEDURAL             MODULE-REQUEST VISUAL
     2.150  MODEL1  PROCEDURAL             CLEAR-BUFFER VISUAL-LOCATION
     2.150  MODEL1  PROCEDURAL             CLEAR-BUFFER VISUAL
     2.150  MODEL2  PROCEDURAL             PRODUCTION-FIRED GAME-OVER
     2.150  MODEL2  PROCEDURAL             MODULE-REQUEST VISUAL
     2.150  MODEL2  PROCEDURAL             CLEAR-BUFFER VISUAL-LOCATION
     2.150  MODEL2  PROCEDURAL             CLEAR-BUFFER VISUAL
     2.150  MODEL1  VISION                 Move-attention VISUAL-LOCATION6-0 NIL
     2.150  MODEL2  VISION                 Move-attention VISUAL-LOCATION6-0 NIL
     2.150  MODEL1  PROCEDURAL             CONFLICT-RESOLUTION
     2.150  MODEL2  PROCEDURAL             CONFLICT-RESOLUTION
     2.235  MODEL1  VISION                 Encoding-complete VISUAL-LOCATION6-0 NIL
     2.235  MODEL1  VISION                 SET-BUFFER-CHUNK VISUAL TEXT0
     2.235  MODEL2  VISION                 Encoding-complete VISUAL-LOCATION6-0 NIL
     2.235  MODEL2  VISION                 SET-BUFFER-CHUNK VISUAL TEXT0
     2.235  MODEL1  PROCEDURAL             CONFLICT-RESOLUTION
     2.235  MODEL1  PROCEDURAL             PRODUCTION-SELECTED WINNER
     2.235  MODEL1  PROCEDURAL             BUFFER-READ-ACTION GOAL
     2.235  MODEL1  PROCEDURAL             BUFFER-READ-ACTION VISUAL
     2.235  MODEL2  PROCEDURAL             CONFLICT-RESOLUTION
     2.235  MODEL2  PROCEDURAL             PRODUCTION-SELECTED LOSER
     2.235  MODEL2  PROCEDURAL             BUFFER-READ-ACTION GOAL
     2.235  MODEL2  PROCEDURAL             BUFFER-READ-ACTION VISUAL
     2.250  MODEL1  SPEECH                 FINISH-MOVEMENT 2.05
     2.285  MODEL1  PROCEDURAL             PRODUCTION-FIRED WINNER
I AM THE WINNER
     2.285  MODEL1  PROCEDURAL             CLEAR-BUFFER GOAL
     2.285  MODEL1  PROCEDURAL             CLEAR-BUFFER VISUAL
     2.285  MODEL2  PROCEDURAL             PRODUCTION-FIRED LOSER
"model1" WAS THE WINNER
     2.285  MODEL2  PROCEDURAL             CLEAR-BUFFER GOAL
     2.285  MODEL2  PROCEDURAL             CLEAR-BUFFER VISUAL
     2.285  MODEL1  PROCEDURAL             CONFLICT-RESOLUTION
     2.285  MODEL2  PROCEDURAL             CONFLICT-RESOLUTION
     2.400  MODEL2  AUDIO                  SET-BUFFER-CHUNK AURAL-LOCATION AUDIO-EVENT3 NIL
     2.400  MODEL1  AUDIO                  find-sound-failure
     2.400  MODEL1  PROCEDURAL             CONFLICT-RESOLUTION
     2.400  MODEL2  PROCEDURAL             CONFLICT-RESOLUTION
     5.100  MODEL2  NONE                   set_game_over model1
     5.100  -       ------                 Stopped because condition is true
'model1'
"""
