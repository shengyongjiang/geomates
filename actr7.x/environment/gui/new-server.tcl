...
proc start_connection {{address ""} {port ""}} {
  ...
  # Should also compare to the address of the actual socket opened....

  if {$address == "localhost" || $address == [ip:address] || $address == [ip:address_local] || $address == [lindex [fconfigure $environment_socket -sockname] 0]} {
